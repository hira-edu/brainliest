...
export const categories = pgTable("categories", {
  ...
  export const insertDetailedAnswerSchema = z.object({
    userId: z.number(),
    questionId: z.number(),
  ...
  export const insertExamAnalyticsSchema = z.object({
    userId: z.number(),
    examId: z.number(),
  ...
  export const insertUserSchema = z.object({
    ...
    passwordHash: z.string().min(1), // Assuming hashed password
  ...
  export const insertExamSessionSchema = z.object({
    ...
    examId: z.number().min(1, { message: 'Exam ID is required' }),
  ...
  // New Schema for Questions
  export const insertQuestionSchema = z.object({
    examId: z.number().min(1, { message: 'Exam ID is required' }),
    subjectId: z.number().min(1, { message: 'Subject ID is required' }),
  ...
  export const dataClassifications = pgEnum('data_classifications', ['public', 'internal', 'sensitive', 'restricted']);
