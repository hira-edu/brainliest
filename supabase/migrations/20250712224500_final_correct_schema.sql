...
-- Step 2: Drop user-defined triggers only
...
ALTER TABLE public.exams
  DROP CONSTRAINT IF EXISTS exams_pkey;
ALTER TABLE public.exams
...
-- Step 10: Update order using a CTE
